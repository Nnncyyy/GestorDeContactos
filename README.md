...
<img src="./capturas/1.png" alt="Agregar muevo contacto 1(0)" width="300" /><br>

► Agregando un segundo y tercer contacto. 
<br><img src="./capturas/2.png" alt="Nuevo contacto 2(1) y 3(2)" width="300" /><br>

► Agregando un cuarto y quinto contacto.  
<img src="./capturas/3.png" alt="Nuevo contacto 4(3) y 5(4)" width="300" /><br>

8. El usuario guardo un total de 5 contactos. 
9. Se ejecuta la opción 5 (Guardar contactos). 
<img src="./capturas/4.png" alt="Se guardan los contactos" width="300" /><br> 

10. Los contactos se guardan en un archivo de texto. <br>
<img src="./capturas/5.png" alt="Datos guardados en un archivo" width="300" /><br>

11. El menú se muestra nuevamente y el usuario selecciona la opción 2 (Mostrar contacto). <br>
<img src="./capturas/6.png" alt="Mostrar contacto" width="300" /><br>
...
<img src="./capturas/7.png" alt="Eliminar contacto" width="300" /><br>
...
<img src="./capturas/8.png" alt="Verificación" width="300" /><br>

17. El usuario seleciona la opción 6 (Cargar contactos desde un archivo).<br>
<img src="./capturas/9.png" alt="Opción 6" width="300" />
